...
<header class="header">
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <a class="navbar-brand cs-navbar-brand" href="/viktorina.live/a_index.php">𝕍𝕀𝕂𝕋𝕆ℝ𝕀ℕ𝔸.𝕃𝕀𝕍𝔼</a>
                ...
                <ul class="navbar-nav justify-content-center w-100 cs-navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu mb-2">
                            <li><a class="dropdown-item" href="/viktorina.live/a_index.php">Klasikinė</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu mb-2">
                            <li><a class="dropdown-item" href="/viktorina.live/b_newquestionindex.php">Klasikinė viktorina</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu mb-2">
                            <li><a class="dropdown-item" href="/viktorina.live/Info/Mano_info/i_myInfo.php">Mano
                                    info</a></li>
                            <li><a class="dropdown-item" href="/viktorina.live/Info/Puslapio_klaidos/i_page_mistake.php">Puslapio klaidos</a>
                            </li>
                            ...
                            <li><a class="dropdown-item" href="/viktorina.live/Info/Klaidos_klausime/i_qna_mistake.php">Klaidos klausime</a>
                            </li>
                            <li>
